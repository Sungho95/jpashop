...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("주문한 수량만큼 재고가 줄어야 한다.", quantity - orderCount, book.getStockQuantity());
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문이 취소된 상품은 취소된 만큼 재고가 증가해야 한다.", 10, item.getStockQuantity());
    }
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "까치산로", "123-123"));
        em.persist(member);
        return member;
    }
